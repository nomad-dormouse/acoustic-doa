...
def segment_audio(input_file="data/shahed.wav", segment_length=2, interval=1, output_dir="data/shahed/segments"):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", default="data/shahed.wav", help="Input WAV file (default: data/shahed.wav)")
